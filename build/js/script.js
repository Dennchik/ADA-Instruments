jQuery('document').ready(function() {
  ...
  function footerToBottom() {
    ...
    jQuery('#main').css({
      'min-height': browserHeight - footerOuterHeight - mainHeightMarginPaddingBorder - 120,
    });
  };
  footerToBottom();
  ...
  jQuery('.main_slider_desk').on('init', function(e, slick) {
    var jQueryfirstAnimatingElements = jQuery('div.main_slider_desk_item:first-child').find('[data-animation]');
    doAnimations(jQueryfirstAnimatingElements);
  });
  jQuery('.main_slider_desk').on('beforeChange', function(e, slick, currentSlide, nextSlide) {
    var jQueryanimatingElements = jQuery('div.main_slider_desk_item[data-slick-index="' + nextSlide + '"]').find('[data-animation]');
  ...
  jQuery(".mobile_menu .has_child a").click(function() {
    jQuery(this).parents(".has_child").find(".sub_menu").slideToggle("150", function() {
      // Animation complete.
    });
  });
  ////////////////////////////////////
  ...
  $(".feedback_form").on("submit", function(event) {
    $(this).parents('.mp_feedback_body').find(".succes_message").fadeIn(400).delay(2000).fadeOut(400);
  ...
  jQuery(".open_search").click(function() {
    jQuery(this).parents(".top_search_wrap").find(".top_search_body").slideToggle("slow", function() {
      // Animation complete.
    });
  });
  //////////////////
  ...
  jQuery("#open_child_list").click(function() {
    jQuery(this).parents(".footer_menu").find(".footer_menu_mob_submenu").slideToggle("slow", function() {
      // Animation complete.
    });
  });
  ////////////////
  ...
  jQuery(".open_menu_child").click(function() {
    jQuery(this).parents("li").find(".sub_menu").slideToggle("slow", function() {
      // Animation complete.
    });
  });
  ...
  jQuery(".open_contacts_list").click(function() {
    jQuery(this).parents(".contact_page_body_box").toggleClass('open').find(".contacts_list_wpapper").slideToggle("slow", function() {
      // Animation complete.
    });
  });
  ////////////////////
  ...
  jQuery(".filters_open").click(function() {
    jQuery(this).parents(".filters_wrapper").toggleClass('open').find(".filters_block").slideToggle(300, function() {
      // Animation complete.
    });
  });
  //////////////////
  ...
  //   });
  jQuery(".open_instr").click(function() {
    jQuery(this).parents(".instr_items_greed").siblings("ul").find("li").find(".open_instr").removeClass('active');
    jQuery(this).parents(".instr_items_greed").siblings("ul").find("li").find(".mob_instruction_wrapper").slideUp(300);
    jQuery(this).parents("li").siblings("li").find(".open_instr").removeClass('active');
    jQuery(this).parents("li").siblings("li").find(".mob_instruction_wrapper").slideUp(300);
    jQuery(this).toggleClass('active').parents("li").find(".mob_instruction_wrapper").slideToggle(300, function() {
      // Animation complete.
    });
  });
  jQuery(document).click(function(e) {
    if (jQuery(e.target).closest(".mob_instruction_wrapper,.open_instr").length) return;
  ...
  jQuery("#open_sf").click(function() {
    jQuery(this).parents(".suport_feedback").find(".suport_feedback_form_wrapper").fadeIn(400);
    return false;
  });


  jQuery(".suport_form").on("submit", function(event) {
    $(this).parents('.suport_feedback').find(".suport_feedback_form_wrapper").hide();
    $(this).parents('.suport_feedback').find(".succes_message").fadeIn(400).delay(2000).fadeOut(400);
    event.preventDefault();
  ...
  jQuery(".open_item").click(function() {
    ...
    jQuery(this).parents(".open_item_parent").toggleClass('opened').find(".hidden_item").slideToggle('400', function() {
